...
#PreviousMonth{
    ...
    <div class="jumbotron">
     ...
     <div class="row">
		...
		<header>
			<h1 style=" position: absolute; top: -24px; left: 89px; width: 880px;"><a id="A2" runat="server" class="btn btn-primary btn-lg" href="~/CalendarApril2017" style="font-size: 15px; top: 315px; left: 258px;"> &laquo; Previous Month</a>&nbsp;May 2017
                <a id="A1" runat="server" class="btn btn-primary btn-lg" href="~/CalendarJune2017" style="font-size: 15px; top: 315px; left: 676px;">Next Month »</a></h1>
            <p>
                &nbsp;</p>
            <p>&nbsp;</p>           	
		</header>
